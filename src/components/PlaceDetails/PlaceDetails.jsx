...
import {Box ,Button , Typography, Card , CardMedia , Chip, CardContent, CardActions} from '@material-ui/core';
        ...
        <div>
            <Card elevation={6}>
                ...
                <CardContent>
                    ...
                    {place?.awards?.map((award) => (<Box my="1" display="flex" justifyContent="space-between" align="center">
